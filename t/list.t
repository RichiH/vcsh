...
test_setup 'Create repo and commits' \
...
test_expect_success 'List command respects $XDG_CONFIG_HOME' \
	...
	test_when_finished "doit | test_env XDG_CONFIG_HOME=\"$PWD/xdg1\" $VCSH delete test1" &&
	test_env XDG_CONFIG_HOME="$PWD/xdg2" $VCSH init test2 &&
	test_when_finished "doit | test_env XDG_CONFIG_HOME=\"$PWD/xdg2\" $VCSH delete test2" &&
...
test_expect_success 'List command respects $HOME' \
	...
	test_when_finished "doit | test_env HOME=\"$PWD/home1\" $VCSH delete test1" &&
	test_env HOME="$PWD/home2" $VCSH init test2 &&
	test_when_finished "doit | test_env HOME=\"$PWD/home2\" $VCSH delete test2" &&
...
test_expect_success 'List command prioritizes $XDG_CONFIG_HOME over $HOME' \
	...
	test_when_finished "doit | test_env HOME=\"$PWD/xh1\" $VCSH delete correct" &&
	test_env HOME="$PWD/xh2" $VCSH init wrong &&
	test_when_finished "doit | test_env HOME=\"$PWD/xh2\" $VCSH delete wrong" &&
...
test_expect_success 'List command prioritizes $VCSH_REPO_D over $HOME' \
	...
	test_when_finished "doit | test_env HOME=\"$PWD/rdh1\" $VCSH delete correct" &&
	test_env HOME="$PWD/rdh2" $VCSH init wrong &&
	test_when_finished "doit | test_env HOME=\"$PWD/rdh2\" $VCSH delete wrong" &&
...
test_expect_success 'List command prioritizes $VCSH_REPO_D over $XDG_CONFIG_HOME' \
	...
	test_when_finished "doit | test_env XDG_CONFIG_HOME=\"$PWD/xhrd1\" $VCSH delete correct" &&
	test_env XDG_CONFIG_HOME="$PWD/xhrd2" $VCSH init wrong &&
	test_when_finished "doit | test_env XDG_CONFIG_HOME=\"$PWD/xhrd2\" $VCSH delete wrong" &&
...
test_expect_success 'List command respects $VCSH_REPO_D' \
	...
	test_when_finished "doit | test_env VCSH_REPO_D=\"$PWD/rd1\" $VCSH delete test1" &&
	test_env VCSH_REPO_D="$PWD/rd2" $VCSH init test2 &&
	test_when_finished "doit | test_env VCSH_REPO_D=\"$PWD/rd2\" $VCSH delete test2" &&
